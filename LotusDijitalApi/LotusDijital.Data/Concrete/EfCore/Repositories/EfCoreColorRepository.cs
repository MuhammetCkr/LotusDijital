...
{
    public class EfCoreColorRepository : EfCoreGenericRepository<Color>, IColorRepository
    {
        public EfCoreColorRepository(LotusDijitalDbContext _context) : base(_context) { }
