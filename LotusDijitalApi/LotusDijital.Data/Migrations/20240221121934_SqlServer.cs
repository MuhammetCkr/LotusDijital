        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Trendyol = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Hepsiburada = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Ciceksepeti = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PageKeyword = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InnerPages", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "DocumentGalleries",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    InnerPageId = table.Column<int>(type: "int", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Url = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentGalleries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentGalleries_InnerPages_InnerPageId",
                        column: x => x.InnerPageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentGalleries_InnerPageId",
                table: "DocumentGalleries",
                column: "InnerPageId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentGalleries_ProductId",
                table: "DocumentGalleries",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ImageGalleries_InnerPageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoGalleries_InnerPageId",
                table: "VideoGalleries",
                column: "InnerPageId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoGalleries_ProductId",
                table: "VideoGalleries",
                column: "ProductId");
        }
